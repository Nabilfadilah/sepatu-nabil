...
function Edit() {
    ...
    // yang digunakan untuk melakukan navigasi ke halaman lain pada aplikasi React yang menggunakan routing
    const navigate = useNavigate() 
    // yang digunakan untuk mendapatkan informasi mengenai lokasi URL saat ini.
    const location = useLocation()
    // digunakan untuk mengirimkan data dari halaman sebelumnya ke halaman baru yang dibuka melalui navigasi.
    // digunakan untuk mendapatkan data dari halaman sebelumnya melalui objek
